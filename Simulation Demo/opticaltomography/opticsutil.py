...
#     print(fxlin)
    ...
    pupil_mask   = (fxlin**2 + fylin**2 <= af.max(fxlin)**2).as_type(af_complex_datatype)
...
#     pupil_mask   = (fxlin**2 + fylin**2 <= af.max(fxlin)**2).as_type(af_complex_datatype)
    q2           = fxlin**2 + fylin**2
    pupil_mask   = af.to_array(1/(1+(q2/(pupil_sigma**2))**pupil_power)).as_type(af_complex_datatype)
#     pupil        = pupil * pupil_mask
    return pupil_mask
